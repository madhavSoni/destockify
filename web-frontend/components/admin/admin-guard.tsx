    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center px-4">
        <div className="max-w-md w-full text-center">
          {/* Login Required Icon */}
          <div className="mb-6">
            <div className="inline-flex items-center justify-center w-20 h-20 rounded-md bg-blue-600/10 text-blue-600">
          ...
          <p className="font-normal text-lg text-black/70 mb-8">
          ...
          <Link
            ...
            className="inline-flex items-center justify-center gap-2 px-8 py-3 bg-blue-600 text-white font-semibold rounded-md hover:bg-blue-700 transition-colors"
          >
          ...
          <div className="mt-6">
            <Link
              href="/"
              className="text-sm text-black/50 hover:text-black hover:underline underline-offset-2"
            >
              ← Back to Home
            </Link>
          </div>
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center px-4">
        <div className="max-w-md w-full text-center">
          {/* Lock Icon */}
          <div className="mb-6">
            <div className="inline-flex items-center justify-center w-20 h-20 rounded-md bg-black/5 text-black">
              <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <p className="font-normal text-lg text-black/70 mb-2">
            You don't have permission to access the admin panel.
          </p>
          <p className="font-normal text-sm text-black/50 mb-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link
              href="/"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 bg-blue-600 text-white font-semibold rounded-md hover:bg-blue-700 transition-colors"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <Link
              href="/profile"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 bg-white text-black font-semibold rounded-md border-2 border-black/10 hover:bg-black/5 transition-colors"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
              </svg>
