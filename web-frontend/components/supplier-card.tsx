...
export function SupplierCard({ 
  ...
  return (
    <Link
      ...
      className={clsx(
        'group relative flex flex-col overflow-hidden rounded-xl border-2 border-black/10 bg-white shadow-sm transition-all duration-300 hover:border-blue-600 hover:shadow-xl hover:-translate-y-1 h-full',
    ...
    >
      ...
      <div className="flex flex-1 flex-col p-4">
        ...
        <div className="flex items-center justify-between pt-3 mt-3 border-t border-black/5">
          ...
          <div className="flex h-8 w-8 items-center justify-center rounded-md bg-blue-600 text-white shadow-sm transition-all duration-200 group-hover:translate-x-1 group-hover:bg-blue-700 group-hover:scale-110">
