...
function HeroSection() {
  return (
    <section className="relative overflow-hidden border-b border-slate-200 bg-white">
      {/* Subtle blue bubble behind headline */}
      ...
      <div className="mx-auto max-w-6xl px-4 py-14 sm:px-6 sm:py-20 lg:px-8">
        <div className="relative inline-block w-full">
          {/* Light blue bubble/emblem behind text */}
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 h-48 w-[90%] sm:w-[85%] md:h-56 md:w-[80%] rounded-full bg-gradient-to-r from-blue-100 via-blue-200 to-blue-100 opacity-60 blur-2xl" />
  ...
  return (
    <section className="mx-auto max-w-[95vw] px-4 sm:px-6 lg:px-8">
      <div className="grid gap-6 py-20 md:grid-cols-2">
        ...
        <article className="group overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm flex flex-col transition hover:shadow-md">
          <div className="p-6">
...
function GuideStrip({ leadGuide }: { leadGuide?: GuideList[number] }) {
  ...
  return (
    <section className="relative overflow-hidden bg-slate-900 text-center text-white my-12">
      ...
      <div className="relative px-4 py-16">
        <h3 className="text-3xl font-semibold max-w-3xl mx-auto leading-snug sm:text-4xl">{title}</h3>
        <Link
          href={href}
...
function ListBusinessCta() {
  return (
    <section className="my-20">
      <div className="group mx-auto max-w-6xl rounded-2xl border border-slate-200 bg-slate-900 p-8 text-white shadow-lg transition hover:shadow-xl sm:p-10 relative overflow-hidden">
